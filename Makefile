...
fuzzingbook.box: $(ARTIFACT)
	...
	cd artifact && vagrant ssh -c 'cat jupyter_notebook_config.py | sed -e "s/#c.NotebookApp.ip = .localhost./c.NotebookApp.ip = \"0.0.0.0\"/g" > /home/vagrant/.jupyter/jupyter_notebook_config.py'
