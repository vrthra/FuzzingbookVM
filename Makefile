...
fuzzingbook.box: $(ARTIFACT)
	...
	cd artifact && vagrant ssh -c 'cat jupyter_notebook_config.py | sed -e "s/#c.NotebookApp.ip = .localhost./c.NotebookApp.ip = \"0.0.0.0\"/g" -e "s/^c.NotebookApp.default_url.*/c.NotebookApp.default_url = \"\/notebooks\/notebooks\/00_Table_of_Contents.ipynb\"/g" > /home/vagrant/.jupyter/jupyter_notebook_config.py'
